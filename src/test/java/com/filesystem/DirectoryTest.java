...
public class DirectoryTest {
    ...
    public void testThatSearchDirectoryIsFound() {
        ...
        Directory<String> findDirectory = user.searchDirectory(user, "Music", new Directory<>("find"));
    ...
    public void testThatDirectoryIsDeleted() {
        ...
        Directory<String> findDirectory = user.searchDirectory(user, "Games", new Directory<>("find"));
        Directory<String> deletedDir = findDirectory.deleteDirectory();

        Assert.assertNull(user.searchDirectory(user, deletedDir.getName(), new Directory<>("find")));
    ...
    public void testThatDirectoryIsUpdated() {
        ...
        Directory<String> findToUpdateDirectory = user.searchDirectory(user, "Games", new Directory<>("find"));
         ...
         */
        Assert.assertNull(user.searchDirectory(user, "Games", new Directory<>("find")));
    ...
    public void testThatDirectoryIsMoved() {
        ...
        isMoved = music.moveDirectory(toWatchMovies);
