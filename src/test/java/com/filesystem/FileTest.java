...
public class FileTest {
    ...
    public void testThatFileIsDeleted() {
        ...
        Directory<String> findMovies = home.searchDirectory(home, "Movies", new Directory<>("find"));
        Directory<String> findGames = home.searchDirectory(home, "Games", new Directory<>("find"));
    ...
    public void testThatFileIsMoved() {
        ...
        Directory<String> movie1from = home.searchDirectory(home, movie1.getParentName(), new Directory<>("find"));
        Directory<String> movie2from = home.searchDirectory(home, movie2.getParentName(), new Directory<>("find"));

        Directory<String> action = home.searchDirectory(home, "Action", new Directory<>("find"));
